...
**SOLUTION:** Added `onclick="window.deleteNoteCard('${listId}', '${card.id}')"` handler to the delete button. The delete button was already rendered but lacked the click handler.
