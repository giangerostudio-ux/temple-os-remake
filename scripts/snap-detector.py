...
TITLE_BAR_HEIGHT_PX = 70     # Increased from 60 - includes headerbar for apps like Nautilus
...
class SnapDetector:
    ...
    def is_click_on_titlebar(self, xid, mouse_x, mouse_y):
        ...
        try:
            ...
            titlebar_bottom = win_y + 35  # Generous buffer into client area (was 30, now 35)
