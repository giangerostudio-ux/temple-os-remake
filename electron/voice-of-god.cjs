...
class VoiceOfGod {
    constructor(options = {}) {
        ...
        // Use bryce-medium voice model only
        this.modelPath = path.join(this.piperDir, 'en_US-bryce-medium.onnx');
        console.log('[VoiceOfGod] Model path:', this.modelPath);
        console.log('[VoiceOfGod] Model exists:', fs.existsSync(this.modelPath));
